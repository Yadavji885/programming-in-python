db = {}
with open ("Decimal to Binary.txt") as f :
    for i in range(16):
        a = f.readline()
        temp = a.split()
        db.update({temp[0] : temp[1]})

ob = {}
with open ("Octal to Binary.txt") as f :
    for j in range(8):
        b = f.readline()
        temp1 = b.split()
        ob.update({temp1[0] : temp1[1]})

hb = {}
with open ("Hexa to Binary.txt") as f :
    for k in range(16):
        c = f.readline()
        temp2 = c.split()
        hb.update({temp2[0] : temp2[1]})
